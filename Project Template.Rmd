...
no_mi_cov <- df[,c("X", "...1", "Date", "Max_Temp", "Min_Temp", "Total_Precip", "year", "epiweek")]
noro_mi1_df <- cbind(noro_mi1, no_mi_cov)
noro_mi2_df <- cbind(noro_mi2, no_mi_cov)
noro_mi3_df <- cbind(noro_mi3, no_mi_cov)
noro_mi4_df <- cbind(noro_mi4, no_mi_cov)
noro_mi5_df <- cbind(noro_mi5, no_mi_cov)
...
write.csv(noro_mi1_df, "noro_mi1_df.csv")
write.csv(noro_mi2_df, "noro_mi2_df.csv")
write.csv(noro_mi3_df, "noro_mi3_df.csv")
write.csv(noro_mi4_df, "noro_mi4_df.csv")
write.csv(noro_mi5_df, "noro_mi5_df.csv")
```
