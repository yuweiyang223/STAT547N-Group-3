...
ggplot(data=rmse, aes(x)) + 
  geom_line(aes(y = rmse_mi), color = "darkred") + 
  geom_line(aes(y = rmse_ts), color="steelblue") +
  geom_line(aes(y=rmse_am),color = "red") 
...
ggplot(data=bias, aes(x)) + 
  geom_line(aes(y = bias_mi), color = "darkred") + 
  geom_line(aes(y = bias_ts), color="steelblue") +
  geom_line(aes(y=bias_am),color = "red")
```
